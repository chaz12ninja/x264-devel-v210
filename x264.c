...
#define H2 if(longhelp==2) printf
    ...
    H1( "      --avcintra-compat <integer> Enable compatibility hacks for AVC-Intra support\n"
        "                                  - 50, 100, 50-p2, 100-p2. P2 formats are designed to mimic P2 AVC-Intra\n"
        "                                    with only an SPS/PPS in the first frame \n" );
...
static struct option long_options[] =
{
    ...
    { "avcintra-compat", required_argument, NULL, 0 },
